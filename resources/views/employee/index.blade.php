                ...
                <table class="table table-bordered table-stiped fs-1 text-black">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$items->emp_midname}}</td>
                            <td>{{$items->emp_age}}</td>
                            <td>{{$items->emp_address}}</td>
                            <td>{{$items->emp_zip}}</td>
                            <td>
                                <a href="{{ route('employee.edit', $items->id) }}" class="btn btn-success btn-sm">
                                    Edit
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('employee.delete', $items->id) }}" class="btn btn-danger btn-sm">
                                    Delete
                                </a>
                            </td>
